...
const DB = 'mongodb+srv://baodb:7TBVz7dP6ZeRNexQ@cluster0.z4hlq.mongodb.net/natour?retryWrites=true&w=majority'
const DATABASE_LOCAL = 'DATABASE_LOCAL=mongodb://127.0.0.1:27017/natour'
// mongoose.connect(DATABASE_LOCAL,{ // Connect db local host 
mongoose.connect(DB,{ // v6 not suppot affter config so we use v5.5.2 
